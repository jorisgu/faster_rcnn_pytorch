...
imdb_train_name_0 = 'rgbdp_train_4_rgb'
imdb_train_name_1 = 'rgbdp_train_4_depth'
imdb_test_name_0 = 'oneraroom_hard_rgb'
imdb_test_name_1 = 'oneraroom_hard_depth_8bits'

save_name = 'rgbdp_x_train_4_on_oneraroom_hard_rgbd_10000'
trained_model_0 = pytorchpath+'models/'+imdb_train_name_0+'/faster_rcnn_5000.h5'
trained_model_1 = pytorchpath+'models/'+imdb_train_name_1+'/faster_rcnn_5000.h5'
