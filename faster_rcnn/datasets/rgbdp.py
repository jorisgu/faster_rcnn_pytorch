...
class rgbdp(imdb):
    def __init__(self, image_set, encoding, devkit_path=None):
        imdb.__init__(self, 'rgbdp_' + image_set+'_'+encoding)
        ...
        assert os.path.exists(self._devkit_path), 'rgbdp path does not exist: {}'.format(self._devkit_path)
